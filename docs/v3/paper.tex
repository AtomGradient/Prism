...
\usepackage{array}
\usepackage{tabularx}
% No CJK fonts needed — all content is English
...
\midrule
\multirow{6}{*}{Normal}
  & user\_03 & 31 & Elementary teacher & Day 35: Pregnancy confirmed \\
  & user\_04 & 26 & Graduate student & Day 45: Thesis major revision, defense postponed \\
  & user\_05 & 27 & E-commerce ops & Day 30: Promoted to team lead \\
  & user\_06 & 29 & Freelance illustrator & Day 60: Lands \yen{}50K client project \\
  & user\_10 & 38 & Fund manager & Day 25: Fund 4\% single-day drawdown \\
  & lixiang & 15 & Middle school student & Day 40: Exam rank drops 15 places \\
\midrule
\multirow{5}{*}{Unexpected}
  & user\_01 & 22 & Factory worker & Day 40: Laid off, 2 weeks no income \\
  & user\_07 & 33 & Hospital resident & Day 21: Medication error, internal warning \\
  & wangguilan & 71 & Retired teacher, alone & Day 55: Falls in bathroom, hides from family \\
...
\midrule
\multirow{3}{*}{Severe}
  & user\_02 & 28 & Delivery rider & Day 46: Traffic accident, hospitalized \\
  & user\_08 & 32 & Tech P7 engineer & Day 55: Laid off N+1, divorce \\
  & user\_09 & 45 & Business owner & Day 38: \yen{}800K bad debt, cash flow collapse \\
\bottomrule
\end{tabularx}
\end{table}
...
\begin{itemize}[leftmargin=*,itemsep=2pt]
  \item \textbf{L1 (Watch):} Single-domain anomaly. High sensitivity,
    low precision.
  \item \textbf{L2 (Warning):} Two or more domains show concurrent
    anomalies within a 7-day window.
  \item \textbf{L3 (Crisis):} Three or more domains converge, or a
...
(business owner). His debt crisis (Day 38, \yen{}800K bad debt) initially
